...
program
    ...
    .option('-i, --ignore <ignore>', 'list of globbed filepaths separated by comma, specifies all files that match a certain pattern should be ignored (i.e. /x/y/*.html will match all files in that directory with .html suffix)')
...
var ignore = program.ignore && program.ignore.split(',');
